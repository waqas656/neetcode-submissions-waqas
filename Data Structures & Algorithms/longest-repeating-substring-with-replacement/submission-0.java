class Solution {
    public int characterReplacement(String s, int k) {
        ...
        //      else:
        //          compare maxWindow with current window using right - left and update maxWindow if applicable
        //          
        ...
        while (right < s.length()) {
            ...
            // find most frequent character in Map
            char freqChar = getMostFrequentCharacter(freqMap);

            int windowSize = right - left + 1;

            boolean isValidWindow = (windowSize - freqMap.get(freqChar)) <= k;
